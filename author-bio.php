		...
		<div class="usa-bbg-author-text">
			...
			<div class="usa-bbg-author-description">
					<?php 
						...
						echo '<div class="usa-bbg-author-occupation">' . $occupation . '</div>';
						...
						if ( $twitterHandle && $twitterHandle != '' ) {
							...
							echo '<div class="usa-bbg-author-contact"><a href="//www.twitter.com/' . $twitterHandle. '">@' . $twitterHandle . '</a> ' . $website .'</div>';
						}
					?>
